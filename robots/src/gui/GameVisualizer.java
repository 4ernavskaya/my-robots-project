...
public class GameVisualizer extends JPanel {
    ...
    public GameVisualizer() {
        ...
        // Задаём предпочтительный размер, чтобы BorderLayout корректно вычислял геометрию
    ...
    private void moveRobot(double velocity, double angularVelocity, double duration) {
        ...
        if (!Double.isFinite(newX)) newX = m_robotPositionX;
        if (!Double.isFinite(newY)) newY = m_robotPositionY;
